...
class control_node(object):
    ...
    def gui(self):
        ...
        timg = PIL.Image.open('Icon/Takeoff.jpg')
        ...
        limg = PIL.Image.open('Icon/Land.jpg')
        ...
        fimg = PIL.Image.open('Icon/For.jpg')
        ...
        bimg = PIL.Image.open('Icon/Back.jpg')
        ...
        rimg = PIL.Image.open('Icon/right.jpg')
        ...
        leimg = PIL.Image.open('Icon/left.jpg')
        ...
        simg = PIL.Image.open('Icon/hold.jpg')
        ...
        eimg = PIL.Image.open('Icon/exit.jpg')
